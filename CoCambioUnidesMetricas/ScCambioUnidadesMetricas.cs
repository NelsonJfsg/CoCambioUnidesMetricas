...
namespace CoCambioUnidesMetricas
{
    public partial class ScCambioUnidadesMetricas : UserControl
    {
        ...
        public ScCambioUnidadesMetricas()
        {
            InitializeComponent();
        }

        //Evento click del boton conversion.
